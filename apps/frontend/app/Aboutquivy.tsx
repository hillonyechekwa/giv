...
const Aboutquivy = () => {
  return (
        <section className="grid grid-rows-1 grid-cols-1 w-full">
          <div className="text-center space-y-4 bg-quivyPurple w-full p-8 flex flex-col justify-center items-center text-white">
